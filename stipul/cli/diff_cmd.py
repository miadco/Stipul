...
def register(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    parser.add_argument("--charter-a", required=True)
    parser.add_argument("--charter-b", required=True)
...
def run(args: argparse.Namespace) -> int:
    try:
        ...
        contract_a = load_charter(Path(args.charter_a)).contract
        contract_b = load_charter(Path(args.charter_b)).contract
