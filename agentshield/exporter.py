...
from agentshield.cli.io import (
    ensure_session_dir,
    read_jsonl,
    sha256_file,
    sha256_bytes,
...
from agentshield.scanner import scan_report_from_dict
...
TRUST_BOUNDARIES = {
    "proxy_proves": [
        "Tool calls routed through the MCP Proxy were evaluated against the supplied signed contract.",
