...
from agentshield.proxy.session_lock import FileLock, acquire_session_lock, release_session_lock
from agentshield.proxy.startup import check_secret_isolation
from agentshield.signing.keys import load_or_create_keypair
...
class ProxyServer:
    ...
    def session_close(
        ...
        from agentshield.events.summary import (
            build_summary,
            summary_to_event,
            write_summary_json,
        )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="AgentShield MCP Proxy")
